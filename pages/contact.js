          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative bg-white shadow-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                {/* Contact information */}
                <div className="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-usedgrade to-blue-700 sm:px-10 xl:p-12">
                  ...
                  <dl className="mt-8 space-y-6">
                    ...
                    <dd className="flex text-base text-blue-50">
                      <PhoneIcon
                        ...
                        aria-hidden="true"
                      />
                      <span className="ml-3">+1 (253) 432-8990</span>
                    </dd>
                    <dt>
                ...
                <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                  ...
                  >
                    ...
                    <div className="sm:col-span-2 sm:flex sm:justify-end">
                      <button
                        type="submit"
                        className="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-usedgrade hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:w-auto"
                      >
                        Submit
                      </button>
                    </div>
